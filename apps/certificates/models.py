...
from apps.core.validators import validate_file_size, validate_pdf
...
class CertificateTemplate(models.Model):
    ...
    background_image = models.ImageField(
        "صورة الخلفية", upload_to="certificate_templates/", blank=True,
...
class Certificate(models.Model):
    ...
    pdf_file = models.FileField(
        "ملف PDF", upload_to="certificates/", blank=True,
