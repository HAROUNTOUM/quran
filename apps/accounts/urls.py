...
urlpatterns = [
    ...
    path("dashboard/exams/<int:pk>/submit-approval/", views.admin_exam_submit_approval, name="admin_exam_submit_approval"),
    ...
    path("dashboard/exams/<int:pk>/bulk-grade/", views.admin_exam_bulk_grade, name="admin_exam_bulk_grade"),
    ...
    path("dashboard/student/requests/create/", views.student_request_create, name="student_request_create"),
